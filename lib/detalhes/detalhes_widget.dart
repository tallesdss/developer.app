  ...
  Widget build(BuildContext context) {
    return StreamBuilder<ReceitasRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final detalhesReceitasRecord = snapshot.data;
        return Scaffold(
          key: scaffoldKey,
                                  ...
                                  Container(
                                    ...
                                    child: Align(
                                      ...
                                      child: InkWell(
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'DETALHES_PAGE_Icon_ahog6i8g_ON_TAP');
                  ...
                  Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Html(
                          data: detalhesReceitasRecord.preparo,
                        ),
                      ),
                      FlutterFlowYoutubePlayer(
                        url: detalhesReceitasRecord.video,
                        autoPlay: false,
                        looping: false,
                        mute: false,
                        showControls: true,
